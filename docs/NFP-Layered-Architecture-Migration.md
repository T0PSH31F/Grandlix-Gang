...
| Source | Target |
|--------|--------|
| `flake-parts/system/base.nix` | `layers/00-foundation/base.nix` |
| `flake-parts/system/nix-settings.nix` | `layers/00-foundation/nix-settings.nix` |
| `flake-parts/system/networking.nix` | `layers/00-foundation/networking.nix` |
| `flake-parts/system/caches.nix` | `layers/00-foundation/caches.nix` |
| `flake-parts/system/optimization.nix` | `layers/00-foundation/optimization.nix` |
| `flake-parts/system/overlays.nix` | `layers/00-foundation/overlays.nix` |
| `flake-parts/system/clan-lib.nix` | `layers/00-foundation/clan-lib.nix` |
| `flake-parts/system/resource-limits.nix` | `layers/00-foundation/resource-limits.nix` |
| `flake-parts/system/fonts.nix` | `layers/00-foundation/fonts.nix` |

Create `layers/00-foundation/default.nix` that imports all of the above.

### Layer 10 — Hardware

| Source | Target |
|--------|--------|
| `flake-parts/hardware/*.nix` (all 13 files) | `layers/10-hardware/*.nix` |
...
| Source | Target |
|--------|--------|
| `flake-parts/features/nixos/virtualization.nix` | `layers/20-system/virtualization.nix` |
| `flake-parts/features/nixos/impermanence.nix` | `layers/20-system/impermanence.nix` |
| `flake-parts/features/nixos/appimage.nix` | `layers/20-system/appimage.nix` |
| `flake-parts/features/nixos/flatpak.nix` | `layers/20-system/flatpak.nix` |
| `flake-parts/features/nixos/mobile-support.nix` | `layers/20-system/mobile-support.nix` |
| `flake-parts/features/nixos/gaming.nix` | `layers/20-system/gaming.nix` |
| `flake-parts/features/nixos/packages/` (all 7 files) | `layers/20-system/packages/` |
| `flake-parts/system/ai-agent-stack.nix` | `layers/20-system/ai-agent-stack.nix` |
| `flake-parts/system/nix-tools.nix` | `layers/20-system/nix-tools.nix` |

Create `layers/20-system/default.nix` that imports all of the above.

### Layer 30 — Services

| Source | Target |
|--------|--------|
| `flake-parts/services/ai/*.nix` (7 files) | `layers/30-services/ai/` |
| `flake-parts/services/infrastructure/*.nix` (18 files) | `layers/30-services/infrastructure/` |
| `flake-parts/services/media/*.nix` (7 files) | `layers/30-services/media/` |
| `flake-parts/services/communication/*.nix` (5 files) | `layers/30-services/communication/` |

Preserve the existing `default.nix` aggregators within each subdirectory.
Create a top-level `layers/30-services/default.nix` that imports all four subdirectories.

### Layer 40 — Desktop

| Source | Target |
|--------|--------|
| `flake-parts/features/nixos/desktop/*.nix` (5 files) | `layers/40-desktop/` |
| `flake-parts/themes/*.nix` (5 files) | `layers/40-desktop/themes/` |

Create `layers/40-desktop/default.nix` that imports the desktop modules and themes.
...
2. Create directory skeleton (`layers/`, `profiles/`, `lib/`, `clan/`, `home/`, `users/`)
...
1. **Copy** (not move) files to `layers/00-foundation/` and `layers/10-hardware/`
...
1. **Copy** files to `layers/20-system/` and `layers/30-services/`
...
1. **Copy** files to `layers/40-desktop/`
...
- [ ] All `layers/` directories created with `default.nix` aggregators
