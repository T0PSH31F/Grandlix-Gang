  ...
  config = lib.mkIf cfg.enable {
    programs.starship = {
      ...
      settings = {
        ...
        # =========================
        format = ''
          [ ](cyan)$os[](bg:black fg:yellow)$localip[](bg:cyan fg:purple)$directory[](bg:black fg:cyan)$env_var[ ](black)$fill$memory[ ](purple)$git_branch$git_status[](bg:purple fg:cyan)$rust$nodejs$python$c$cpp$docker_context[ ](fg:cyan)
        ...
        character = {
          ...
          error_symbol = "[ 👾 ](bg:black fg:red)[](fg:red) ";
        };
