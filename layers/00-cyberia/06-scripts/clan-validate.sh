...
if [ -f "layers/Home-Manager/yazi/yazelix.nix" ]; then
...
if [ -f "layers/nixos/system/desktop-portals.nix" ]; then
...
if [ -d "layers/Home-Manager/Desktop-env/Noctalia" ]; then
    print_status "success" "Noctalia directory structure exists"
    
    if [ -f "layers/Home-Manager/Desktop-env/Noctalia/default.nix" ]; then
        print_status "success" "  - Noctalia default.nix exists"
    fi
    
    if [ -f "layers/Home-Manager/Desktop-env/Noctalia/hyprland/keybinds.nix" ]; then
        print_status "success" "  - Noctalia Hyprland keybinds exist"
    fi
    
    if [ -f "layers/Home-Manager/Desktop-env/Noctalia/hyprland/ipc.nix" ]; then
        print_status "success" "  - Noctalia Hyprland IPC exists"
    fi
    
    if [ -f "layers/Home-Manager/Desktop-env/Noctalia/niri/default.nix" ]; then
...
if [ -f "layers/Home-Manager/tools/keybinds.nix" ]; then
