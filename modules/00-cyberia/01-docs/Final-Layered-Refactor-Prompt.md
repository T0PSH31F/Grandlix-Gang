...
│   │   │   │   ├── nvidia.nix
│   │   │   │   └── nvidia-hybrid.nix
│   │   │   ├── 123-peripherals/                     # Input/output devices
│   │   │   │   ├── bluetooth.nix
│   │   │   │   ├── touchpad.nix
│   │   │   │   └── razer.nix
│   │   │   ├── 124-platform/                        # Platform profiles
│   │   │   │   ├── common.nix
│   │   │   │   ├── audio.nix
│   │   │   │   └── laptop.nix
...
| `hardware/intel.nix` | `12-hardware/121-cpu/intel.nix` |
| `hardware/intel-7th-gen.nix` | `12-hardware/121-cpu/intel-7th-gen.nix` |
| `hardware/intel-12th-gen.nix` | `12-hardware/121-cpu/intel-12th-gen.nix` |
| `hardware/amd.nix` | `12-hardware/122-gpu/amd.nix` |
| `hardware/nvidia.nix` | `12-hardware/122-gpu/nvidia.nix` |
| `hardware/nvidia-hybrid.nix` | `12-hardware/122-gpu/nvidia-hybrid.nix` |
| `hardware/bluetooth.nix` | `12-hardware/123-peripherals/bluetooth.nix` |
| `hardware/touchpad.nix` | `12-hardware/123-peripherals/touchpad.nix` |
| `hardware/razer.nix` | `12-hardware/123-peripherals/razer.nix` |
...
| `packages/desktop.nix` | `60-gui/packages-desktop.nix` | Desktop packages belong with GUI |
| `packages/dev.nix` | `50-cli/packages-dev.nix` | Dev tools are primarily CLI |
| `packages/media.nix` | `60-gui/62-media/packages-media.nix` | Media packages with media apps |
| `packages/ai.nix` | `70-agents/packages-ai.nix` | AI packages with AI agents |
| `packages/pentest.nix` | `60-gui/66-security/packages-pentest.nix` | Security packages with security tools |
| `features/nixos/gaming.nix` | `60-gui/65-gaming/gaming.nix` | Gaming is primarily apps + multi-class handles system bits |
...
### 50-cli/ ← `features/home/cli/`

| Source | Target |
|--------|--------|
| `features/home/cli/shells/` | `50-cli/51-shells/` |
| `features/home/cli/editors/` | `50-cli/52-editors/` |
| `features/home/cli/tools/` | `50-cli/53-tools/` |
| `features/home/cli/multiplexers/` | `50-cli/54-multiplexers/` |
| `features/home/cli/prompt/` | `50-cli/55-prompt/` |
| `features/home/cli/file-managers/` | `50-cli/56-file-managers/` |
| `features/home/cli/services/` | `50-cli/57-services/` |
| `features/home/cli/theming/` + `vivid.nix` | `50-cli/58-theming/` |
| `features/home/cli/integrations/` + `yazelix.nix` | `50-cli/59-integrations/` |
| `features/home/core.nix` + `cli-tui.nix` | `50-cli/50-entry/` |

### 60-gui/ ← `features/home/gui/` (non-desktop)

| Source | Target |
|--------|--------|
| `features/home/gui/desktop/browsers/` | `60-gui/61-browsers/` |
| `features/home/gui/desktop/media/` + `spicetify.nix` | `60-gui/62-media/` |
| `features/home/gui/documents/` | `60-gui/63-documents/` |
| `features/home/gui/vscode.nix` + `dev-tools.nix` | `60-gui/64-development/` |
| `features/home/gui/gaming-apps.nix` + `nixos/gaming.nix` | `60-gui/65-gaming/` |
| `features/home/gui/pentest-tools.nix` | `60-gui/66-security/` |
...
| **4** | `cp` `40-desktop/`, `50-cli/`, `60-gui/`, `70-agents/` | `git add . && nix flake check` |
