...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        exec-once = [
          ...
          "${pkgs.pipewire}/bin/pw-play ~/Clan/NFP/modules/00-cyberia/02-assets/SFX/login-sound.mp3 & disown"
          # "noctalia-shell & disown" # Managed by systemd
        ];

        # Exec on shutdown
        exec-shutdown = [
          "${pkgs.pipewire}/bin/pw-play ~/Clan/NFP/modules/00-cyberia/02-assets/SFX/shutdown-sound.mp3"
        ];
    ...
    xdg.configFile."hypr/vibrancy.frag".source = ../../../modules/00-cyberia/02-assets/vibrancy.frag;
